scoreboard players remove Zelený TheBridge1 1
execute if score Zelený TheBridge1 matches ..-5 as @a[team=tb1.4] run function tb1:elimin
...
execute at @s as @a[distance=0..] run function niki:text/odbodoval/ze
