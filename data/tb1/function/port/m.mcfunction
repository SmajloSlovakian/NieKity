scoreboard players remove Modrý TheBridge1 1
execute if score Modrý TheBridge1 matches ..-5 as @a[team=tb1.2] run function tb1:elimin
...
execute at @s as @a[distance=0..] run function niki:text/odbodoval/m
