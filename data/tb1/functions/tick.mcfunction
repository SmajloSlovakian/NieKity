...
execute unless score odpočet tb1casovac matches 101.. if entity @a[x=23,y=53,z=228,dx=-2,predicate=niki:blockstart] run scoreboard players set odpočet tb1casovac 0
execute unless score odpočet tb1casovac matches 101.. if entity @a[x=19,y=53,z=228,dx=-2,predicate=niki:blockstart] run scoreboard players set odpočet tb1casovac 0
execute unless score odpočet tb1casovac matches 101.. if entity @a[x=25,y=53,z=224,dz=2,predicate=niki:blockstart] run scoreboard players set odpočet tb1casovac 0
execute unless score odpočet tb1casovac matches 101.. if entity @a[x=15,y=53,z=224,dz=2,predicate=niki:blockstart] run scoreboard players set odpočet tb1casovac 0
