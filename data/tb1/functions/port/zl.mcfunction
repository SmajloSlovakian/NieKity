scoreboard players remove Žltý TheBridge1 1
execute if score Žltý TheBridge1 matches ..-5 as @a[team=tb1.3] run function tb1:elimin
...
execute at @s as @a[distance=0..] run function niki:text/odbodoval/zl
