execute if score @s nikimusic matches ..30627 if score @s nikimusicp matches 30628.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.start record @s ~ ~ ~ 1
execute if score @s nikimusic matches ..30607 if score @s nikimusicp matches 30608.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.loop1 record @s ~ ~ ~ 1
...
execute if score @s nikimusic matches ..20267 if score @s nikimusicp matches 20268.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.loop2_start record @s ~ ~ ~ 1
execute if score @s nikimusic matches ..20255 if score @s nikimusicp matches 20256.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.loop2 record @s ~ ~ ~ 1
...
execute if score @s nikimusic matches ..10222 if score @s nikimusicp matches 10223.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.loop2_start record @s ~ ~ ~ 1 1.2
execute if score @s nikimusic matches ..10212 if score @s nikimusicp matches 10213.. as @a[distance=0..] at @s run playsound niki:music.bonetrousle.loop2 record @s ~ ~ ~ 1 1.2
