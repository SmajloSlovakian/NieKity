title @a[tag=1,scores={jazyk=0,return=1..6}] title {"text":"Yellow scored!","color":"#FFFF00"}
title @a[tag=1,scores={jazyk=1,return=1..6}] title {"text":"Žltý bodoval!","color":"#FFFF00"}
