title @a[tag=1,scores={jazyk=0,return=1..6}] title {"text":"Blue scored!","color":"#0000FF"}
title @a[tag=1,scores={jazyk=1,return=1..6}] title {"text":"Modrý bodoval!","color":"#0000FF"}
