title @a[tag=1,scores={jazyk=0,return=1..6}] title {"text":"Red scored!","color":"#FF0000"}
title @a[tag=1,scores={jazyk=1,return=1..6}] title {"text":"\u010cervený bodoval!","color":"#FF0000"}
