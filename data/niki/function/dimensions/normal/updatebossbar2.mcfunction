...
$bossbar set $(name)/r players @a[distance=0..]
$bossbar set $(name)/b players @a[distance=0..]
$bossbar set $(name)/y players @a[distance=0..]
$bossbar set $(name)/g players @a[distance=0..]
