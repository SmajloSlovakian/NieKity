...
execute if score map pvp1 matches 4.. run scoreboard players set map pvp1 0

execute if score map pvp1 matches 0 run data merge block 3 21 9 {front_text:{messages:['{"text":"Mapa","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function pvp1:nastavenia/mapa"}}','{"text":"Sumo","color":"#808080"}','[{"text":"> ","color":"#00FF00"},{"text":"MiniPvP","color":"#00FFFF"},{"text":" <","color":"#00FF00"}]','{"text":"MaxiPvP","color":"#808080"}']}}
...
execute if score map pvp1 matches 3 run data merge block 3 21 9 {front_text:{messages:['{"text":"Mapa","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function pvp1:nastavenia/mapa"}}','{"text":"Hrad","color":"#808080"}','[{"text":"> ","color":"#00FF00"},{"text":"Sumo","color":"red"},{"text":" <","color":"#00FF00"}]','{"text":"MiniPvP","color":"#808080"}']}}
