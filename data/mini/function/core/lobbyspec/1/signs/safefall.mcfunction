...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].safefall
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Poranenie pádu","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/safefall"}}'
data modify storage lobby:signsettings setvalues[1].safefall set from storage niki:nbt Buffer
