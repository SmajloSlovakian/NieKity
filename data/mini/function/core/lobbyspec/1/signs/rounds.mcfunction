...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].rounds
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Minimum kôl","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/rounds"}}'
data modify storage lobby:signsettings setvalues[1].rounds set from storage niki:nbt Buffer
