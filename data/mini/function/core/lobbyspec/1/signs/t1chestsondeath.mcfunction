...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].t1chestsod
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"T1 truhlice","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/t1chestsondeath"}}'
data modify storage lobby:signsettings setvalues[1].t1chestsod set from storage niki:nbt Buffer
