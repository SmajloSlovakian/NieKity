...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].spawncrown
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Počet korún","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/spawncrown"}}'
data modify storage lobby:signsettings setvalues[1].spawncrown set from storage niki:nbt Buffer
