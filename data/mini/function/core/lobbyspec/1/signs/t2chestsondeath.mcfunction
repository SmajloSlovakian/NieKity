...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].t2chestsod
...
data modify storage lobby:signsettings setvalues[1].t2chestsod set from storage niki:nbt Buffer
