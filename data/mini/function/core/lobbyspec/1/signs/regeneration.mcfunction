...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].regeneration
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Regenerácia","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/regeneration"}}'
data modify storage lobby:signsettings setvalues[1].regeneration set from storage niki:nbt Buffer
