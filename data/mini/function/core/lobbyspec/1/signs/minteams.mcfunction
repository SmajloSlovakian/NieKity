...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].minteams
...
data modify storage lobby:signsettings setvalues[1].minteams set from storage niki:nbt Buffer
