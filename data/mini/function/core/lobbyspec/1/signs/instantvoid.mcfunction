...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].instantvoid
...
data modify storage lobby:signsettings setvalues[1].instantvoid set from storage niki:nbt Buffer
