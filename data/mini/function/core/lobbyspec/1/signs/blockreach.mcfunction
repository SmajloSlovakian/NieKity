...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].blockreach
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Dosah na kocky","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/blockreach"}}'
data modify storage lobby:signsettings setvalues[1].blockreach set from storage niki:nbt Buffer
