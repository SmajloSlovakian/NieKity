...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].vacuumtype
...
data modify storage lobby:signsettings setvalues[1].vacuumtype set from storage niki:nbt Buffer
