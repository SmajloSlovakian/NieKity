...
execute if score a nikimath matches 0 run attribute @s attack_speed base set 0
execute if score a nikimath matches 8 run attribute @s attack_speed base set 0.8
execute if score a nikimath matches 9 run attribute @s attack_speed base set 0.9
execute if score a nikimath matches 10 run attribute @s attack_speed base set 1
execute if score a nikimath matches 16 run attribute @s attack_speed base set 1.6
execute if score a nikimath matches 40 run attribute @s attack_speed base set 4
execute if score a nikimath matches 10240 run attribute @s attack_speed base set 1024
...
execute if score a nikimath matches 0 run attribute @s block_interaction_range base set 0
execute if score a nikimath matches 10 run attribute @s block_interaction_range base set 1
execute if score a nikimath matches 45 run attribute @s block_interaction_range base set 4.5
execute if score a nikimath matches 10240 run attribute @s block_interaction_range base set 1024
...
execute if score a nikimath matches 0 run attribute @s safe_fall_distance base set 0
execute if score a nikimath matches 5 run attribute @s safe_fall_distance base set 0.5
execute if score a nikimath matches 10 run attribute @s safe_fall_distance base set 1
execute if score a nikimath matches 30 run attribute @s safe_fall_distance base set 3
execute if score a nikimath matches 10240 run attribute @s safe_fall_distance base set 1024
