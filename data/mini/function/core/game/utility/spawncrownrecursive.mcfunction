...
summon item ~ 100 ~ {Item:{id:"minecraft:golden_helmet",components:{"minecraft:item_name":'"Koruna"',"minecraft:enchantments":{"niki:hit_detector":1,"binding_curse":1}}},Tags:["1"]}
