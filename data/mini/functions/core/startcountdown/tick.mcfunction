...
execute if score startcountdown nikimini matches 20 run function mini:core/utility/forceload
...
execute if score startcountdown nikimini matches ..0 if function mini:core/utility/checkforceload run function mini:core/game/start/start1

execute if score dimension nikimini matches 0 unless score startcountdown nikimini matches 99 run scoreboard players remove startcountdown nikimini 1
execute if score dimension nikimini matches 1.. run scoreboard players remove startcountdown nikimini 1
