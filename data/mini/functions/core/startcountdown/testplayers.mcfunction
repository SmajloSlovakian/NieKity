...
execute as @a[tag=1] run function mini:init/connectplayer
execute as @a[tag=2] run function mini:init/connectplayer
execute as @a[tag=3] run function mini:init/connectplayer
execute as @a[tag=4] run function mini:init/connectplayer
