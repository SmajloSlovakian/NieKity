...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].kit
...
data modify storage lobby:signsettings setvalues[1].kit set from storage niki:nbt Buffer
