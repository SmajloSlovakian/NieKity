...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].scoretype
...
data modify storage lobby:signsettings setvalues[1].scoretype set from storage niki:nbt Buffer
