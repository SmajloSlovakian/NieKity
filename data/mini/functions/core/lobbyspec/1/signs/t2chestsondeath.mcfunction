...
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"T2 truhlice","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/t2chestsondeath"}}'
