...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].scoreonkill
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Scoreonkill","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/scoreonkill"}}'
data modify storage lobby:signsettings setvalues[1].scoreonkill set from storage niki:nbt Buffer
