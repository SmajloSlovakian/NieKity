...
execute positioned 3 22 8 run function niki:handlesignsetting
data modify block 3 22 8 front_text.messages[0] set value '{"text":"Oživenia","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/revives"}}'
