...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[0].instantvoid
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Instantvoid","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/instantvoid"}}'
data modify storage lobby:signsettings setvalues[0].instantvoid set from storage niki:nbt Buffer
