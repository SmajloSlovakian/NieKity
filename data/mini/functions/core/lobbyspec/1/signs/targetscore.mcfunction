...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[0].targetscore
...
data modify storage lobby:signsettings setvalues[0].targetscore set from storage niki:nbt Buffer
