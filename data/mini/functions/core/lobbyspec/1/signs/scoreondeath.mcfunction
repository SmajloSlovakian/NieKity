...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[1].scoreondeath
function niki:handlesignsetting
data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Scoreondeath","color":"#FFFFFF","clickEvent":{"action":"run_command","value":"function mini:core/lobbyspec/1/signs/scoreondeath"}}'
data modify storage lobby:signsettings setvalues[1].scoreondeath set from storage niki:nbt Buffer
