...
data modify storage niki:nbt Buffer set from storage lobby:signsettings setvalues[0].scoredisplay
...
data modify storage lobby:signsettings setvalues[0].scoredisplay set from storage niki:nbt Buffer
