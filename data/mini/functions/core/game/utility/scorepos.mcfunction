...
execute as @a[tag=2] run function lobby:latekill/nikitohandle
execute as @a[tag=3] run function lobby:latekill/nikitohandle
execute as @a[tag=4] run function lobby:latekill/nikitohandle
execute as @a[tag=5] run function lobby:latekill/nikitohandle
