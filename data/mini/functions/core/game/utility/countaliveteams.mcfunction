...
execute as @a[scores={return=1..6},team=nikia,tag=!spect] run scoreboard players add a nikimath 1
execute as @a[scores={return=1..6},team=nikip,tag=!spect] run scoreboard players add a nikimath 1
