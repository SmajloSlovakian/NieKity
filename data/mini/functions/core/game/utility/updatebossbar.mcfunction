...
execute unless entity @a[scores={return=1..6},team=nikir] run scoreboard players set c nikimath -1
execute unless entity @a[scores={return=1..6},team=nikib] run scoreboard players set d nikimath -1
execute unless entity @a[scores={return=1..6},team=nikiy] run scoreboard players set e nikimath -1
execute unless entity @a[scores={return=1..6},team=nikig] run scoreboard players set f nikimath -1
