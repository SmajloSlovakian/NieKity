...
execute if entity @a[tag=1,predicate=niki:blockstart,scores={deathtimep=0}] run return 0
...
execute if entity @a[tag=2,predicate=niki:blockstart,scores={deathtimep=0}] run return 0
scoreboard players set a nikimath 0
...
execute if entity @a[tag=3,predicate=niki:blockstart,scores={deathtimep=0}] run return 0
scoreboard players set a nikimath 0
...
execute if entity @a[tag=4,predicate=niki:blockstart,scores={deathtimep=0}] run return 0
scoreboard players set a nikimath 0
