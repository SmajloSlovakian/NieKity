...
execute unless score start bw1casovac matches 101.. if entity @a[x=-203,y=100,z=-197,dx=6,dy=1,dz=1,predicate=niki:blockstart] run scoreboard players set start bw1casovac 0
